...
# function pose_costfn(joint_pos::AbstractVector, joint_goal::AbstractVector)
#     sqrt(sq_norm(joint_pos .- joint_goal))
# end
...
#     for i = 1:(info.n_timesteps - 1)
#         append!(ret_val, [GeneralCost{n,m}((x, u) -> pose_costfn(x, info.joint_target), false)]);
#     end
#     append!(ret_val, [GeneralCost{n,m}(x->pose_costfn(x, info.joint_target), true)]);
#     ret_val
# end
